...
import { Bike, Building2, Hotel, TrendingDown, TrendingUp, UserRound } from "lucide-react";
          ...
          <div className="flex min-w-fit items-center justify-center rounded-md border">
            <CardBody className="text-center">
              ...
              {loading ? (
                ...
                <Typography variant="h3" className={`${customerTrend?"text-primary":"text-[#C70381]"}`}>
                  {activeCustomers}
                </Typography>
                {customerTrend?<TrendingUp className="text-primary"/>:<TrendingDown className="text-[#C70381]"/>}
                </div>
              )}
            </CardBody>
          </div>
          ...
          <div className="flex min-w-fit items-center justify-center rounded-md border">
            <CardBody className="text-center">
              ...
              {loading ? (
                ...
                <div className="flex flex-row items-center justify-center gap-2">
                  <Typography variant="h3" className={`${riderTrend?"text-primary":"text-[#C70381]"}`}>
                  {activeRiders}
                </Typography>
                {riderTrend?<TrendingUp className="text-primary"/>:<TrendingDown className="text-[#C70381]"/>}
                </div>

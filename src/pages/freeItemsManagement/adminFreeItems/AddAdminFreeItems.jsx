...
const AddAdminFreeItemsModal = ({
  ...
  return (
    ...
    // >
    //   <DialogHeader className="ml-0 pb-1 pl-1 text-sm text-white">
    //     <span>Add New Admin Free Item</span>
    //     <button
    ...
    //             }}
    //           >
    //             <Tab value="form" onClick={() => setActiveTab("form")}>
    //               Free Item Details
    //             </Tab>
    //             <Tab value="stores" onClick={() => setActiveTab("stores")}>
    //               Select Stores
    //             </Tab>
    //           </TabsHeader>
    //           <TabsBody className="h-[75vh]">
    //             <TabPanel value="form">
    //               {/* Free Item Form */}
    //               <Input
    //                 label="Title"
    ...
    //               <div className="rounded-none md:flex-row px-4">
    //                 <div className="float-end m-1 flex flex-row gap-1 md:w-72">
    //                   {/* <Button size="sm" onClick={toggleSelectAllStores}>
    //                   <span className="text-nowrap w-full">
    //                     {" "}
    //                     {allStoreIds.every((id) => selectedStores.includes(id))
    //                       ? "Deselect All"
    //                       : "Select All"}{" "}
    //                   </span>
    //                 </Button> */}
    ...
    //                             id={`store-${store.id}`}
    //                             onChange={(e) =>
    //                               handleCheckboxChange(e, store.id)
    //                             }
    //                             checked={selectedStores.includes(store.id)}
    //                           />
    //                         </td>
    ...
    //     {activeTab === "stores" ? (
    //       <>
    //         <Button onClick={() => setActiveTab("form")} disabled={saving}>
    //           Back
    //         </Button>
    //         <Button
    ...
    //       </>
    //     ) : (
    //       <Button className="bg-primary" onClick={() => setActiveTab("stores")}>
    //         Next
    //       </Button>
    //     )}
    //   </DialogFooter>
